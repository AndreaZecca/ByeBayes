...
selfHarmAndViolenceProb ["oldfemale"] = 0.0008 * alpha
...
sicknessProb ["truefalsefalse" ] = 0.010356 * alpha
...
def datasetConstructor():
    ...
    with open('./data/dataset.csv', 'w') as file:
        ...
        for i in range(1,(10**order)+1):
            ...
            data.append(str(falls).lower())
            data.append(str(poisonings).lower())
            data.append(str(natureForce).lower())
            data.append(str(cardiovascularDisease).lower())
            data.append(str(malignacy).lower())
            data.append(str(respiratoryInfection).lower())
            data.append(str(transportIncident).lower())
            data.append(str(sickness).lower())
            data.append(str(othInjuries).lower())
            data.append(str(unintentional).lower())
            data.append(str(othSickness).lower())
            data.append(str(shv).lower())
            data.append(str(death).lower())
